    ...
    return (
        <header className="max-w-full px-2">
            ...
            <div className="text-center pl-16 pr-16 mb-12 ">
                ...
                <br />
                <p className="text-gray-500">El Centro Cultural El Espacio trae consigo una trayectoria de 8 años gestionando la formación inicial e intermedia de personas afines a disciplinas artísticas y culturales. 
