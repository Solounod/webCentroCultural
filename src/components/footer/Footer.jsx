    ...
    return (
        <footer>
            <div className="bg-gradient-to-r from-orange-500 from-10% via-red-500 via-30% to-pink-500 to-90% md:grid md:grid-cols-3">
                ...
                <section className="p-20 md:pt-20 block md:flex md:justify-between">
                    <div className=" md:mx-10 text-white  ">
                        <h5 className="font-semibold uppercase" >Visitanos:</h5>
                        <hr />
                        <p className="pt-2">3 oriente 7 y 8 norte 1874, Talca, Chile.</p>
                    </div>
                    <div className="text-white  mt-4 md:mt-0">
                        <h5 className="font-semibold uppercase">Contactanos</h5> 
                        <hr />           
                        <p className="pt-2">Teléfono: 990564487</p>
